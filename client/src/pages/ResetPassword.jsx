    ...
    {!isEmailSent && 
      ...
      <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
         ...
         <p className='text-center mb-6 text-indigo-300'>Enter your registerd email address </p>
          ...
          <div className='mb-4 flex items-center gao-3 w-full px-5 py-2.5 rounded-full bg-[#333A5c]'>
 ...
 { !isOtpSubmited && isEmailSent && 
   ...
   {isOtpSubmited && isEmailSent && 
        <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
         ...
         <p className='text-center mb-6 text-indigo-300'>Enter the New Passowrd Below </p>
