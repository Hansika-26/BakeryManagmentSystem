...
import { getProducts, addProduct, updateProduct, deleteProduct, getProductById, toggleProductVisibility } from "../controllers/productController.js";
...
router.patch("/:id/toggle-visibility", authenticateUser, authorizePermissions('admin'), toggleProductVisibility);
